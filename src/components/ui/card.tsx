  ...
  return (
    <div
      ...
      className={cn(
        ...
        "gap-[var(--pad-card)] py-[var(--pad-card)]",
        className
      )}
      {...props}
    />
  ...
  return (
    <div
      ...
      className={cn(
        ...
        "px-[var(--pad-card)] [.border-b]:pb-[var(--pad-card)]",
        className
      )}
      {...props}
    />
...
function CardContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("px-[var(--pad-card)]", className)}
      {...props}
    />
  )
}
...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn("flex items-center px-[var(--pad-card)] [.border-t]:pt-[var(--pad-card)]", className)}
      {...props}
    />
  )
}
